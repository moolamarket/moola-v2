 ...
 **/
contract LendingPoolCollateralManagerWithReserve is
  ...
  LendingPoolStorage
{
  ...
  uint256 internal constant LIQUIDATION_RESERVE_PERCENT = 200;
  ...
  struct LiquidationCallLocalVars {
    ...
    uint256 collateralReserveAmount;
  ...
  function liquidationCall(
    ...
    if (!receiveAToken) {
      ...
      if (
        currentAvailableCollateral < vars.maxCollateralToLiquidate.sub(vars.collateralReserveAmount)
      ) {
        return (
    ...
    if (receiveAToken) {
      ...
      vars.collateralAtoken.transferOnLiquidation(
        user,
        msg.sender,
        vars.maxCollateralToLiquidate.sub(vars.collateralReserveAmount)
      );
    ...
    if (vars.collateralReserveAmount > 0) {
      vars.collateralAtoken.transferOnLiquidation(
        user,
    ...
    )
  {
    ...
    vars.maxAmountCollateralToLiquidate = vars
      ...
      .percentMul(vars.liquidationBonus.add(LIQUIDATION_RESERVE_PERCENT))
    ...
    if (vars.maxAmountCollateralToLiquidate > userCollateralBalance) {
      ...
      debtAmountNeeded = vars
        ...
        .percentDiv(vars.liquidationBonus.add(LIQUIDATION_RESERVE_PERCENT));
    } else {
